...
def plot_errors_and_counts(results_df,
                           ...
                           show_count=True,
                           inline=False):
    """Plots the traces from get_errors_over_cycle_traces and
    get_binned_cycle_count_trace side by side.
    If show_count == False, then only the errors will be plotted in a single
    graph (height and width stay the same).
    """
